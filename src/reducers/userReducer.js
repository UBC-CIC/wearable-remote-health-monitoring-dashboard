const initalUsers = [
    {id: "12345", firstName: "John", lastName: "Smith", age: 75, device: {},
        ...
        imageURL: "https://i.imgur.com/6HAYO4e.png", profileURL: "12345", status: {code: 2, description: "LOST CONTACT"},
        vitals: {id: "123", heartRate: 110}, facility: "Vancouver Care Center", room: "", phoneNumber: "888-888-8888", email: "example@example.com",
    ...
    {id: "58943", firstName: "Jane", lastName: "Doe", age: 83, device: {},
        ...
        imageURL: "https://i.imgur.com/6HAYO4e.png", profileURL: "58943", status: {code: 0, description: "NORMAL"},
    ...
    {id: "10851", firstName: "Jessica", lastName: "Johnson", age: 91, device: {},
        ...
        imageURL: "https://i.imgur.com/6HAYO4e.png", profileURL: "10851", status: {code: 4, description: "OUT OF BOUNDS"},
    ...
    {id: "35836", firstName: "Philip", lastName: "Westinghouse", age: 78, device: {},
        ...
        imageURL: "https://i.imgur.com/6HAYO4e.png", profileURL: "35836", status: {code: 3, description: "HEART RATE HIGH"},
